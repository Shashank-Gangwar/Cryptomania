...
const ProfilePage = () => {
  ...
  const handleChanges = async (e) => {
    ...
    if (updatedEmail !== "" || updatedUserName !== "") {
      await axios
        .post(
          `${import.meta.env.VITE_BASE_URL}/api/v1/users/updateAccountDetails`,
          {
      ...
      await axios
        .post(
          profilePic === "profilePicture.png"
            ? `${import.meta.env.VITE_BASE_URL}/api/v1/users/deleteAvatar`
            : `${import.meta.env.VITE_BASE_URL}/api/v1/users/updateAvatar`,
          {
            avatar: profilePic,
          },
  ...
  const handleDeleteCoin = async (coin) => {
    ...
    await axios
      .post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/users/updateWishlist`,
        {
          coin: coin,
          action: "delete",
        },
